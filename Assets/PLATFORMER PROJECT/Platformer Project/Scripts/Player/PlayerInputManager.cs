...
namespace PLAYERTWO.PlatformerProject
{
	...
	public class PlayerInputManager : MonoBehaviour
	{
		...
		{
			if (!m_player.CanMove || Time.time < m_movementDirectionUnlockTime)
				return Vector3.zero;
		...
		public virtual bool GetJumpUp() => m_player.CanMove && m_jump.WasReleasedThisFrame();

		public virtual bool GetSwimUpward() => m_player.CanMove && m_swimUpward.IsPressed();

		public virtual bool GetDive() => m_player.CanMove && m_dive.IsPressed();

		public virtual bool GetSpinDown() => m_player.CanMove && m_spin.WasPressedThisFrame();

		public virtual bool GetPickAndDropDown() => m_player.CanMove && m_pickAndDrop.WasPressedThisFrame();

		public virtual bool GetCrouchAndCraw() => m_player.CanMove && m_crouch.IsPressed();

		public virtual bool GetAirDiveDown() => m_player.CanMove && m_airDive.WasPressedThisFrame();

		public virtual bool GetStompDown() => m_player.CanMove && m_stomp.WasPressedThisFrame();

		public virtual bool GetReleaseLedgeDown() => m_player.CanMove && m_releaseLedge.WasPressedThisFrame();

		public virtual bool GetGlide() => m_player.CanMove && m_glide.IsPressed();

		public virtual bool GetDashDown() => m_player.CanMove && m_dash.WasPressedThisFrame();

		public virtual bool GetGrindBrake() => m_player.CanMove && m_grindBrake.IsPressed();

		public virtual bool GetPauseDown() => m_player.CanMove && m_pause.WasPressedThisFrame();

		public virtual bool EscPressed()
		{
#if UNITY_STANDALONE
			return m_player.CanMove && Keyboard.current.escapeKey.wasPressedThisFrame;
#else
			return false;
#endif
		}
