...
namespace PLAYERTWO.PlatformerProject
{
	...
	public class PlayerStatsManager : EntityStatsManager<PlayerStats>
	{
        ...
        {
            if (m_game.m_totalCoins >= playerUpgradeSO.upgradeCost)
            {
                m_game.m_totalCoins -= playerUpgradeSO.upgradeCost;
                m_game.m_playerUpgradeStats.boughtUpgrades.Add(playerUpgradeSO.upgradeID);
		...
		private void UpgradeStats(PlayerStats stats)
		{
            ...
            Resources.LoadAll<Base_PlayerUpgradeSO>("Upgrades").Where(upgrade => boughtUpgrades.Contains(upgrade.upgradeID))
